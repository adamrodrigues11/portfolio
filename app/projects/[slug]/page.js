...
export default function ProjectDetails({ params }) {
    ...
    return(
        <main>
            ...
            <div className="py-4 grid grid-cols-1 lg:grid-cols-3-1 gap-y-8 gap-x-0 md:gap-x-8">
                <div className="order-2 lg:order-1 flex flex-col items-start gap-2">
                    ...
                    <div className='flex flex-row flex-wrap justify-center place-items-center gap-6 md:justify-start'>
                    {project.links?.github && <button className='text-lg bg-slate-200 dark:bg-slate-700 py-2 sm:py-4 px-4 sm:px-8 rounded-lg shadow-md hover:scale-102 group'>
                    ...
                    {project.links?.demo && <button className='text-lg bg-slate-200 dark:bg-slate-700 py-2 sm:py-4 px-4 sm:px-8 rounded-lg shadow-md hover:scale-102 group'>
                ...
                <div className="order-1 lg:order-2 max-w-[400px] place-self-center w-full lg:max-w-[500px] aspect-square rounded-md relative z-0 overflow-hidden">
            ...
            <div className="py-4 grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="lg:order-2 flex flex-col items-start gap-2">
                    ...
                    <p className='text-sm sm:text-base'>{project.roleDetails}</p>
                </div>
